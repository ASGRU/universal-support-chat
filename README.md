...
- Регистрация/вход не обязательны для старта диалога.
...
Чтобы открыть клиенту форму авторизации из чата, отправьте в reply одну из команд:

- `/auth` (открыть форму входа)
- `/login` (открыть форму входа)
- `/register` (открыть форму регистрации)
